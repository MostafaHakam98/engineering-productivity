...
// @match        https://gitlab.brightskiesinc.com/*/-/blob/*
// @match        https://gitlab.brightskiesinc.com/*/-/tree/*
// @match        https://gitlab.brightskiesinc.com/*/-/edit/*
// @match        https://gitlab.brightskiesinc.com/*
// @exclude      https://gitlab.brightskiesinc.com/*/-/issues*
// @exclude      https://gitlab.brightskiesinc.com/*/-/merge_requests*
// @exclude      https://gitlab.brightskiesinc.com/*/-/pipelines*
// @exclude      https://gitlab.brightskiesinc.com/*/-/wikis*
// @exclude      https://gitlab.brightskiesinc.com/*/-/snippets*
// @exclude      https://gitlab.brightskiesinc.com/*/-/settings*
// @exclude      https://gitlab.brightskiesinc.com/*/-/activity*
// @exclude      https://gitlab.brightskiesinc.com/*/-/graphs*
// @exclude      https://gitlab.brightskiesinc.com/*/-/network*
// @exclude      https://gitlab.brightskiesinc.com/*/-/compare*
// @exclude      https://gitlab.brightskiesinc.com/*/-/commits*
// @exclude      https://gitlab.brightskiesinc.com/*/-/tags*
// @exclude      https://gitlab.brightskiesinc.com/*/-/releases*
// @exclude      https://gitlab.brightskiesinc.com/*/-/milestones*
...
(function () {
    ...
    function renderTree(rootNode, ctx) {
        ...
        header.innerHTML = `
        <input type="search" class="gl-filetree__filter" placeholder="Filter files… (Ctrl+F)">
        <div class="gl-filetree__controls">
          <button class="gl-filetree__btn" data-action="quick-search" title="Quick file search (Ctrl+P)">🔍 Quick</button>
      ...
      `;
        ...
        function createNodeEl(node, depth = 0) {
            ...
            const fileIcon = isDir ? '📁' : getFileIconForName(node.name);
            ...
            row.innerHTML = `
          <span class="gl-filetree__twisty" ${isDir ? '' : 'style="visibility:hidden"'}>▸</span>
          ...
          <button class="gl-filetree__copy" data-path="${node.path}" title="Copy file path">📋</button>
        `;
