...
|--------------------------|--------------------------|----------------------------------------------|
| `claude-install-global`  | `claude-install-global`  | Install global Claude config to `~/.claude/` |
| `claude-install-project` | `claude-install-project` | Install project template into `./.claude/`   |
| `claude-sync-project`    | `claude-sync-project`    | Sync template updates (non-destructive)      |
| `cdclaudeconfig`         | `cdclaudeconfig`         | Navigate to `~/.claude/`                     |
| `claude-help`            | `claude-help`            | Show all Claude Code commands                |
